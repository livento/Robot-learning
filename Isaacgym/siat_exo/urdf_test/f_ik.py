...
def inverse_kinematics(p_base,p_link,r_base,r_link):
...
if __name__ == '__main__':
    ...
    r_link = np.array([5.0000906e-01, 5.0000226e-01,  4.9999955e-01, 0.49998942])
    q      = inverse_kinematics(p_base,p_link,r_base,r_link)